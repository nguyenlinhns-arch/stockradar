...
def activate(dest):
    ...
    for name in ['execution-config.js','chatgpt-workspace.js','chatgpt-workspace.css']:
    ...
    for path in dest.rglob('*.html'):
        ...
        # Retire browser inference widgets, not account/authentication or report-data scripts.
    ...
    print('CHATGPT_WORKSPACE activated: no legacy inference widget, generic ChatGPT destination, private report reader.')
