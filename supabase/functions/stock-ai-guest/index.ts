...
import { STOCKRADAR_SYSTEM_CORE, appendResearchData, deterministicStockRadarAnswer, normalizeResearchContext, researchSnapshot, stockRadarMode } from "../_shared/stockradar-core.ts";
...
Deno.serve(async req=>{
  ...
  const researchData=researchSnapshot(context);
  ...
  return json({status:'READY',...base,answer_engine:'MODEL_PLUS_STOCKRADAR_DATA',answer:modelText?appendResearchData(modelText,context):fallback},200,origin,rate);
});
