...
class AiRegistrationCtaTests(unittest.TestCase):
    def test_ai_chat_registration_and_upgrade_ctas_follow_account_state(self):
        ...
        self.assertIn("signup/?plan=free", center)
        self.assertIn("signup/?plan=free", assistant)
        ...
        self.assertNotIn("dang-ky/?plan=free", center)
        self.assertNotIn("dang-ky/?plan=free", assistant)
        self.assertNotIn('href="dang-ky/?plan=free"', home)
