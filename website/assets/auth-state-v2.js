(() => {
  ...
  const state = { client: null, user: null, premium: false, observer: null, scheduled: false };
  ...
  function bridgeSessionStorage() {
    ...
    try {
      ...
      if (primary) localStorage.setItem(secondary, primary);
      else localStorage.removeItem(secondary);
    } catch (_) {}
  }
  ...
  function renderHeader() {
    ...
    group.dataset.accountState = state.premium ? 'premium' : 'free';
